    ...
    <aside className="sidebar no-print">
      ...
      <nav className="sidebar-nav">
        ...
        <NavLink to="/sales-persons" className={getLinkClass}>
          <svg style={{ marginRight: 10 }} width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="8" r="4"></circle><path d="M4 20c0-4 3.6-7 8-7s8 3 8 7"></path></svg>
          Sales Persons
        </NavLink>
