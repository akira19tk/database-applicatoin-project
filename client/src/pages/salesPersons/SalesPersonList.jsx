...
import { listSalesPersons, deleteSalesPerson } from "../../api/salesPersons.api.js";   // deleteSalesPerson
...
export default function SalesPersonList() {
  ...
  const confirmDelete = async () => {
    try {
      await deleteSalesPerson(confirmModal.code);   // deleteSalesPerson, code
      closeConfirm();
  ...
  const columns = [
    { key: "code", label: "Code" },          // code
    { key: "name", label: "Name" },          // name
    { key: "start_work_date", label: "Start Date", render: (v) => v ? v.slice(0, 10) : "-" },   // start_work_date
  ];
