...
export default function SalesPersonPage({ mode: propMode }) {
  ...
  React.useEffect(() => {
    ...
    getSalesPerson(code)    // getSalesPerson, code
      .then((sp) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (mode === "create") {
        await createSalesPerson(payload);   // createSalesPerson
      } else {
    ...
    <div>
      ...
      <div className="card">
        <form onSubmit={handleSubmit}>   
          ...
          <button type="submit" className="btn btn-primary" disabled={submitting}>   {/* submitting */}
