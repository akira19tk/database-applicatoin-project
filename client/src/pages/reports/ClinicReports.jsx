...
const REPORTS = [
  // Patients
  {
    key: "patients", group: "Patients", label: "1. All Patients",
  ...
  {
    key: "medical-problems", group: "Diagnoses", label: "2. Medical Problems per Patient",
  ...
  {
    key: "top-conditions", group: "Diagnoses", label: "3. Top N Common Problems", analysis: true,
  ...
  {
    key: "diagnoses", group: "Diagnoses", label: "7/8. Diagnosis Records",
  ...
  // Medicines
  {
    key: "medicines", group: "Medicines", label: "4. All Medicines",
  ...
  {
    key: "prescriptions", group: "Medicines", label: "5. Prescriptions per Patient",
  ...
  {
    key: "top-medicines", group: "Medicines", label: "6. Top N Prescribed Medicines", analysis: true,
  ...
  // Doctors
  {
    key: "doctors", group: "Doctors", label: "10. All Doctors",
  ...
  {
    key: "patients-by-doctor", group: "Doctors", label: "11. Patients Treated by Doctor",
  ...
  {
    key: "top-doctors-by-patients", group: "Doctors", label: "9. Top N Doctors by Patients", analysis: true,
  ...
  {
    key: "most-appointed-doctors", group: "Doctors", label: "12. Most Appointed Doctors", analysis: true,
  ...
  // Visits
  {
    key: "visits", group: "Visits", label: "16/17. Visits (by date / doctor / type)",
  ...
  {
    key: "visits-monthly", group: "Visits", label: "18. OPD vs IPD by Month", analysis: true,
  ...
  // Billing
  {
    key: "print-bill", group: "Billing", label: "13. Print Patient Bill (by Code)", type: "bill",
    filters: [{ name: "billCode", label: "Bill Code", type: "text", placeholder: "e.g. BLL-001" }], requires: ["billCode"],
  },
  {
    key: "bills", group: "Billing", label: "14. All Bills (by date / patient)",
  ...
  {
    key: "revenue-by-charge-type", group: "Billing", label: "15. Revenue by Charge Type", analysis: true,
