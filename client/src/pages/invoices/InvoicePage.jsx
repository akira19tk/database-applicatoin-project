...
export default function InvoicePage({ mode: propMode }) {
            ...
            getInvoice(id)
                .then((inv) => {
                    ...
                    setInitialData({
                        ...
                        vat_rate: h.vat_rate != null ? Number(h.vat_rate) : 0.07,
    ...
    if (isView && invoiceData) {
        ...
        const totalPrice = Number(h.total_price || h.total_amount || 0);
        const totalDiscount = Number(h.total_discount || 0);
        const netPrice = totalPrice - totalDiscount;
        const vatAmount = Number(h.vat_amount || h.vat || 0);
                    ...
                    <div className="mt-4 flex justify-between">
                        ...
                        <div style={{ minWidth: 240 }}>
                            ...
                            <div className="flex justify-between mb-2">
                                ...
                                <span>{formatBaht(totalDiscount)}</span>
                            </div>
                            <div className="flex justify-between mb-2">
                                <span>Net Price:</span>
                                <span>{formatBaht(netPrice)}</span>
                            </div>
                            <div className="flex justify-between mb-2">
