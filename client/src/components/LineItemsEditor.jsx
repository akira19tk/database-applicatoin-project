...
export default function LineItemsEditor({ value, onChange }) {
    ...
    function computeNetPrice(it) {
        const extended = computeExtended(it);
        return Math.round((extended - computeDiscountAmount(it)) * 100) / 100;
    }
                ...
                <table className="modern-table" style={{ fontSize: '0.9rem' }}>
                    <thead>
                        <tr>
                            ...
                            <th style={{ width: '12%' }} className="text-right">Disc %</th>     
                            <th style={{ width: '12%' }} className="text-right">Disc Amt</th>  
                ...
                <div style={{ 
                    ...
                    <div style={{ 
                        ...
                        <span style={{ 
                            ...
                            Total Discount ({items.length} item{items.length !== 1 ? 's' : ''})
                        </span>
                        <span style={{ 
                            fontSize: '1.25rem',
                            fontWeight: 700,
