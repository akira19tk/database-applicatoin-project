// Single row in the line items table: product code, name, qty, unit price, discount, reorder/remove buttons
    ...
    >
      ...
      <td>
        <div style={{ textAlign: "right", color: "#ef4444", fontSize: "0.9rem" }}>
          {computeDiscountAmount(it) > 0 ? formatBaht(computeDiscountAmount(it)) : "-"}
        </div>
      </td>
      <td>
        <div style={{ textAlign: "right", fontWeight: 600, color: "var(--text-main)", fontSize: "0.95rem" }}>
