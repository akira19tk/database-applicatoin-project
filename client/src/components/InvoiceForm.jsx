...
export default function InvoiceForm({ onSubmit, submitting, initialData }) {
  ...
  const [salesPersonCode, setSalesPersonCode] = React.useState("");    // sales person code
  const [salesPersonName, setSalesPersonName] = React.useState("");    // sales person name
  const [salesPersonModalOpen, setSalesPersonModalOpen] = React.useState(false); // modal open/close
